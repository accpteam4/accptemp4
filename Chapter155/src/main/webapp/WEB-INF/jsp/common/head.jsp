...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            <p><span>下午好！</span><span style="color: #fff21b"> ${userEntity.userName }</span> , 欢迎你！</p>
...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
              <li ><a href="/user/queryBill">订单管理</a></li>
              <li><a href="/user/queryProvider">供应商管理</a></li>
              <li><a href="/user/User">用户管理</a></li>
              <li><a href="/user/ShowList">角色管理</a></li>
              <li><a href="/user/UpdPwd">密码修改</a></li>
